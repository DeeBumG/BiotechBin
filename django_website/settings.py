...
SECRET_KEY = 'django-insecure--@y%n3zfs)ssd_&%(4ubhdpq&gesbb3$nva05ga675-=ubxc&_'
...
INSTALLED_APPS = [
    ...
    'BiotechBin.apps.BiotechbinConfig'
]
...
STATIC_URL = 'static/'
STATIC_ROOT = '/app/static'  # Match the volume mount in docker-compose.yml
...
AUTH_USER_MODEL = 'BiotechBin.User'